function startFakeXpra(_) {
  ...
  setTimeout(function() {
    ...
    $('#xpra-wrapper').show();
    $('#launchXpra').html("&nbsp;You're welcome!&nbsp;<span class=\"fa fa-heart\"></span>&nbsp;")
      .switchClass("btn-danger", "btn-success", 1000, "easeInOutQuad")
      .removeClass("btn-blinky")
      .css("cursor", "default");

    $("#close1").on('click', function(_) {
      $('#xpra-wrapper').hide();
      $('#launchXpra').html("&nbsp;<span class=\"fa fa-desktop\"></span>Try online!&nbsp;")
        .switchClass("btn-success", "btn-warning", 1000, "easeInOutQuad")
        .css("cursor", "pointer");
      return false;
    });
